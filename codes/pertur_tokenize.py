...
def main(model, tk, upper_bound, pertur_bz:int = 50):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hug_name', type=str, default='ckiplab/bert-base-chinese')
    ...
    for data in data_list:
        # for upper_bound in [9, 11, 13, 7]:
        for upper_bound in [8, 10, 12, 14]:
            out_dir = f'./log/perturbed_masking/{hug_name}/bound{upper_bound}'
            os.makedirs(out_dir, exist_ok=True)
            main(model, tk, upper_bound, pertur_bz=args.pertur_bz)
